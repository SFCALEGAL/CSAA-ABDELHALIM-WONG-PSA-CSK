# Stub: August 27, 2026 personal-dialogue letter (body not duplicated)
...
- [LETTER-TO-OCONNELL-AUG27-2026.md](../../LETTER-TO-OCONNELL-AUG27-2026.md)
- Email-ready twin: [LETTER-TO-OCONNELL-AUG27-2026-EMAIL.md](../../LETTER-TO-OCONNELL-AUG27-2026-EMAIL.md)

**Sent status:** Published on this site August 27, 2026. **Not claimed served.** Do not treat the public post as email service on Porter Scott.

**Rule 3:** Visible redaction markers appear where required. The marker does not describe the withheld words. This thread is not listed as court-seen unredacted.
...
This block was added to the public archive on August 27, 2026. It is commentary. It is not part of the original email, not a court filing, not service, and does not restart any Code of Civil Procedure section 128.7 clock. If this thread is a lodged exhibit, this block is not part of the exhibit.

**Thread.** Curated class page. See [THREADS.md](../full-archive/THREADS.md) for the mailbox chronology. prior: [STUB-2026-08-21-letter.md](STUB-2026-08-21-letter.md) · next: (none) · thread index: [THREADS.md](../full-archive/THREADS.md)
